...
st.title("Carte du Sénégal") # Optionnel : ajoute un titre
st.components.v1.html(ma_carte._repr_html_(), height=1000) 
# OU si tu as installé streamlit-folium :
# from streamlit_folium import st_folium
# st_folium(ma_carte, width=700)